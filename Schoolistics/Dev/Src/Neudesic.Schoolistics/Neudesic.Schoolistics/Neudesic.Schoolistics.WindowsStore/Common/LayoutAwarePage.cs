    ...
    public class LayoutAwarePage : MvxStorePage
    {
        ...
        public LayoutAwarePage()
        {
            try
            {
                ...
                topAppBarControl appbarControl = new topAppBarControl();
                appbarControl.HomeButtonClick += appbarControl_HomeButtonClick;
                appbarControl.NewsarticlebuttonClick += appbarControl_NewsarticlebuttonClick;
                appbarControl.BookmarkbuttonClick += appbarControl_BookmarkbuttonClick;
                appbarControl.CompareButtonClick += appbarControl_CompareButtonClick;
                appbarControl.SurveybuttonClick += appbarControl_SurveybuttonClick;
                topAppBar.Content = appbarControl;
            ...
            {
                Mvx.Error("Error in LayoutAwarePage.cs : Constructor: " + ex.ToString());
            }
        }

        private void appbarControl_SurveybuttonClick(object sender, RoutedEventArgs e)
        {
            try
            {
                ((BaseViewModel)ViewModel).NavigateToViewModel<SurveyViewModel>();
            }
            catch (Exception ex)
            {
                Mvx.Error("Error in LayoutAwarePage.cs : appbarControl_SurveybuttonClick: " + ex.ToString());
            }
        }

        private void appbarControl_CompareButtonClick(object sender, RoutedEventArgs e)
        {
            try
            {
                ((BaseViewModel)ViewModel).NavigateToViewModel<CompareschoolsViewModel>();
            }
            catch (Exception ex)
            {
                Mvx.Error("Error in LayoutAwarePage.cs : appbarControl_CompareButtonClick: " + ex.ToString());
            }
        }

        private void appbarControl_BookmarkbuttonClick(object sender, RoutedEventArgs e)
        {
            try
            {
                ((BaseViewModel)ViewModel).NavigateToViewModel<BookmarkedSchoolItemsPageViewModel>();
            }
            catch (Exception ex)
            {
                Mvx.Error("Error in LayoutAwarePage.cs : appbarControl_BookmarkbuttonClick: " + ex.ToString());
            }
        }

        private void appbarControl_NewsarticlebuttonClick(object sender, RoutedEventArgs e)
        {
            try
            {
                ((BaseViewModel)ViewModel).NavigateToViewModel<NewsArticlesItemsViewModel>();
            }
            catch (Exception ex)
            {
                Mvx.Error("Error in LayoutAwarePage.cs : appbarControl_NewsarticlebuttonClick: " + ex.ToString());
            }
        }

        private void appbarControl_HomeButtonClick(object sender, RoutedEventArgs e)
        {
            try
            {
                ((BaseViewModel)ViewModel).NavigateToViewModel<HubpageViewModel>();
            }
            catch (Exception ex)
            {
                Mvx.Error("Error in LayoutAwarePage.cs : appbarControl_NewsarticlebuttonClick: " + ex.ToString());
        ...
        protected virtual void GoHome(object sender, RoutedEventArgs e)
        {
            ...
            {
                Mvx.Error("Error in LayoutAwarePage.cs : GoHome: " + ex.ToString());
            }
        ...
        protected virtual void GoBack(object sender, RoutedEventArgs e)
        {
            ...
            {
                Mvx.Error("Error in LayoutAwarePage.cs : GoBack: " + ex.ToString());
            }
        }
        ...
        protected virtual void GoForward(object sender, RoutedEventArgs e)
        {
            ...
            {
                Mvx.Error("Error in LayoutAwarePage.cs : GoForward: " + ex.ToString());
            }
        }
        ...
        private void CoreDispatcher_AcceleratorKeyActivated(CoreDispatcher sender, AcceleratorKeyEventArgs args)
     {
         try
         {
            ...
            {
                Mvx.Error("Error in LayoutAwarePage.cs : CoreDispatcher_AcceleratorKeyActivated: " + ex.ToString());
            }
        ...
        private void CoreWindow_PointerPressed(CoreWindow sender, PointerEventArgs args)
        {
            ...
            {
                Mvx.Error("Error in LayoutAwarePage.cs : CoreWindow_PointerPressed: " + ex.ToString());
            }
